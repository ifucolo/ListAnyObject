...
public abstract class EndlessRecyclerViewScrollListener extends RecyclerView.OnScrollListener {
    ...
    private boolean completedLoading = true;
    ...
    public void resetState() {
        resetState(this.startingPageIndex);
    }

    public boolean checkCompletedLoading() {
        if (!completedLoading) {
    ...
    public void setCompletedLoading() {
        this.completedLoading = true;
    }

    public void resetState(int page) {
    ...
    public Bundle getState() {
        ...
        bundle.putInt("previousTotalItemCount", previousTotalItemCount);
